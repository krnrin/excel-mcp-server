...
def _convert_github_url_to_raw(github_url: str) -> str:
    ...
    if "github.com" in github_url:
        ...
        if len(parts) == 2:
            ...
            return f"https://raw.githubusercontent.com/{repo_path}/{branch_and_path}"
...
def read_excel_from_github(
    ...
    try:
        ...
        return f"Error downloading file from GitHub: {str(e)}"
...
def list_sheets_from_github(
    ...
    try:
        ...
        logger.error(f"Error listing sheets from GitHub: {e}")
        raise
    finally:
        if tmp_path:
            try:
